function [recall, precision, averagePrecision, Dd] = LMrecallPrecision(Dgt, Dd, objectname, draw)

% Computes precision, recall, average precision and plots a precision-recall curve.
%
%  [recall, precision, averagePrecision, Dd] = LMrecallPrecision(Dgt, Dd, objectname, draw)
%
